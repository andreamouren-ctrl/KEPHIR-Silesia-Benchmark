#if defined(AURORA_KHEPRI_EXP40)
...
using PipelineBackend = aurora::media::AuroraKhepriExp37MemoryAdapter;
static constexpr const char* kPipelineBackend = "EXP37_DUAL";
#endif
...
int main() {
    try {
        ...
        std::cout<<"backend="<<kPipelineBackend<<" hardware_concurrency="<<std::thread::hardware_concurrency()<<"\n";
