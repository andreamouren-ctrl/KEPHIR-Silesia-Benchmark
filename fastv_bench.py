...
ROOT=Path("silesia"); OUT=Path("fastv_out"); OUT.mkdir(exist_ok=True)
FILES=["dickens","mozilla","mr","nci","ooffice","osdb","reymont","samba","sao","webster","x-ray","xml"]
PROFILES=[("FAST_U","./fast_u"),("FAST_V","./fast_v")]
rows=[]
...
Path("fastv_results.json").write_text(json.dumps(rows,indent=2))
