...
// EXP-42 exact distance-cost cache implementation is included into this translation unit so its current static
...
#endif
#define main aurora_kephir_exp42_cli_main
#include "../../../KEPHIR_2_EXP42_DISTANCE_COST_CACHE.cpp"
#undef main
#if defined(__GNUC__)
...
Bytes AuroraKhepriExp42MemoryAdapter::encode(ByteView input) {
...
Bytes AuroraKhepriExp42MemoryAdapter::decode(ByteView input) {
