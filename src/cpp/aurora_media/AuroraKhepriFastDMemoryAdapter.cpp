...
// FAST-D is included into this translation unit so its current static
...
Bytes AuroraKhepriFastDMemoryAdapter::encode(ByteView input) {
...
Bytes AuroraKhepriFastDMemoryAdapter::decode(ByteView input) {
