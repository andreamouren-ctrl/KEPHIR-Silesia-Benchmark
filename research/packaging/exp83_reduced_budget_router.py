#!/usr/bin/env python3
"""
EXP-83 — Reduced-Budget Representative Router

Purpose:
reduce routing cost while preserving the EXP-82 zero-regret policy.

Only the bounded probe budgets change:
- stage 1: 512 KiB instead of 2 MiB
- stage 2: 2 MiB instead of 12 MiB

All routing semantics remain identical to EXP-82.
...
OUT=ROOT/"exp83_reduced_budget_router"
if OUT.exists():
    shutil.rmtree(OUT)
OUT.mkdir()
INPUTS=OUT/"inputs"
...
result={
    "experiment":"EXP-83",
    "change":"reduced-budget-representative-router",
    "thresholds":{
