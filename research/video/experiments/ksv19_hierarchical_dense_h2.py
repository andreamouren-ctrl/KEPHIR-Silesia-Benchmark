...
2. take the two best sparse vectors;
...
def _best_h2_luma(
    ...
    # Stage 2: refine the two best distinct sparse vectors.
    centers = sparse_ranked[:2]
    neighborhood = set()
...
def main():
    ...
    result = {
        ...
        "hierarchical_policy": "two best sparse-even vectors + union of unique 3x3 integer neighborhoods",
        "rows": rows,
        "aggregate": aggregate,
        "notes": [
