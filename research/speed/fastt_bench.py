...
ROOT=Path("silesia"); OUT=Path("fastt_out"); OUT.mkdir(exist_ok=True)
FILES=["dickens","mozilla","mr","nci","ooffice","osdb","reymont","samba","sao","webster","x-ray","xml"]
PROFILES=[("FAST_O_HASH21","./fast_o"),("FAST_T_HASH22","./fast_t")]
rows=[]
...
Path("fastt_results.json").write_text(json.dumps(rows,indent=2))
