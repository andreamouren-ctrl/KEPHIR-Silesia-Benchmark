...
ROOT=Path("silesia"); OUT=Path("fastz_out"); OUT.mkdir(exist_ok=True)
FILES=["dickens","mozilla","mr","nci","ooffice","osdb","reymont","samba","sao","webster","x-ray","xml"]
PROFILES=[("FAST_Y","./fast_y"),("FAST_Z","./fast_z")]
rows=[]
...
Path("fastz_results.json").write_text(json.dumps(rows,indent=2))
