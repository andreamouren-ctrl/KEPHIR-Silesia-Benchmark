...
ROOT=Path("silesia"); OUT=Path("fasto_out"); OUT.mkdir(exist_ok=True)
FILES=["dickens","mozilla","mr","nci","ooffice","osdb","reymont","samba","sao","webster","x-ray","xml"]
PROFILES=[("FAST_K","./fast_k"),("FAST_O_HASH21","./fast_o")]
rows=[]
...
Path("fasto_results.json").write_text(json.dumps(rows,indent=2))
