...
ROOT=Path("silesia"); OUT=Path("fasts_out"); OUT.mkdir(exist_ok=True)
FILES=["dickens","mozilla","mr","nci","ooffice","osdb","reymont","samba","sao","webster","x-ray","xml"]
PROFILES=[("FAST_O_O3","./fast_o_o3"),("FAST_S_OFAST","./fast_s_ofast")]
rows=[]
...
Path("fasts_results.json").write_text(json.dumps(rows,indent=2))
